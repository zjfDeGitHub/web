<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/index\view\index\indexs.html";i:1542536355;s:71:"C:\phpStudy\PHPTutorial\WWW\tp5\application\index\view\common\head.html";i:1542444376;}*/ ?>
<html><head>
    <meta charset="UTF-8">
                    ...
                    <div class="show_subject" id="tabinfo_child<?php echo $vo['id']; ?>"> <!--此处为CID 栏目ID-->
                        ...
                        <script>
                            $("document").ready(function () {
                                ...
                                $(".suclass").attr("href"," <?php echo url('index/subject',array('suID'=>$suID)); ?>");
                            })
