<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\cate\edit.htm";i:1541747458;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\head.htm";i:1541677570;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.htm";i:1542510307;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url("edit"); ?>" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="<?php echo $cateData['catename']; ?>" name="catename"  type="text">
                                 <input type="hidden" name="id" value="<?php echo $cateData['id']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">栏目简介</label>
                            <div class="col-sm-6">
                              <input class="form-control" id="password" placeholder="<?php echo $cateData['desc']; ?>" name="desc" type="text">
                            </div>
                             <p class="help-block col-sm-4 red">* 必填</p>
                        </div>  
