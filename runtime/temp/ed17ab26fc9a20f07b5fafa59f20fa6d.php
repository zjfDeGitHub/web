<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\user\add.htm";i:1541747185;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\head.htm";i:1541677570;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.htm";i:1542439644;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<div class="page-sidebar" id="sidebar">
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            <a href="#" class="menu-dropdown">
                <i class="menu-icon fa fa-user"></i>
                <span class="menu-text">条目管理</span>
                <i class="menu-expand"></i>
            </a>
            <ul class="submenu">
                <li>
