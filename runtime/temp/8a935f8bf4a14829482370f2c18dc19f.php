<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\subject\lst.htm";i:1541901059;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\head.htm";i:1541677570;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.htm";i:1542510307;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('subject/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                                ...
                                <td align="center"> <?php if($vo['flag']  == ''): ?> 未知 <?php else: ?><?php echo $vo['flag']; endif; ?></td>
