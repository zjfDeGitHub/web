<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\user\edit.htm";i:1542511990;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\head.htm";i:1541677570;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.htm";i:1542510307;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">编辑学生</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url("edit"); ?>" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" value="<?php echo $userData['username']; ?>" name="username"  type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input class="form-control" id="password" placeholder="不填将为原密码" name="password" type="text">
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input class="form-control" id="username" value="<?php echo $userData['class']; ?>" name="class"  type="text">
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input class="form-control" id="username" value="<?php echo $userData['sex']; ?>" name="sex" type="text">
                            </div>

                        </div>
                    <div class="form-group">
                        <label for="group_id" class="col-sm-2 control-label no-padding-right">分数</label>
                        <div class="col-sm-6">
                            <input class="form-control" value="<?php echo $userData['score']; ?>" name="score" type="text">
                        </div>
